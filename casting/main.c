...
int main(int argc, char **argv)
{
	...
	game.map[3] = ft_strdup("10000000S00010000101");
	...
	game.map[11] = NULL;
    // image_texture
    game.texture_file_name = "red_brick.xpm";
    game.texture = mlx_xpm_file_to_image(game.mlx_ptr,game.texture_file_name,&game.width_tex,&game.height_tex);
    // game.addr_texture = mlx_get_data_addr(game.texture,&game.bits_per_pixel_texture,&game.line_length_texture,&game.endian_texture);
    //-----------------------------------------------------------------
